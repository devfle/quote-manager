...
const GenericDialog: React.FC<DialogProps> = ({ children, dialogTitle, isAbortable = true, dialogActionBtnText, dialogCloseBtnText, isOpen, dialogActionMethod, dialogCloseMethod }) => {
  return (
    <Dialog keepMounted aria-describedby="alert-dialog-slide-description" open={isOpen}>
      ...
      <DialogActions>
        ...
        <Button variant="contained" onClick={dialogActionMethod}>
          {dialogActionBtnText}
        </Button>
      </DialogActions>
    </Dialog>
